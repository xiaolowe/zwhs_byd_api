...
import cn.org.citycloud.zwhs.mpsdk4j.core.JsonMsgBuilder;
import cn.org.citycloud.zwhs.mpsdk4j.exception.WechatApiException;
import cn.org.citycloud.zwhs.mpsdk4j.session.AccessTokenMemoryCache;
import cn.org.citycloud.zwhs.mpsdk4j.session.JSTicketMemoryCache;
import cn.org.citycloud.zwhs.mpsdk4j.session.MemoryCache;
...
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.FollowList;
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.Follower;
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.Follower2;
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.Groups;
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.JSTicket;
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.Media;
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.Menu;
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.QRTicket;
import cn.org.citycloud.zwhs.mpsdk4j.vo.api.Template;
    ...
    private synchronized void refreshAccessToken() {
        ...
        for (int i = 0; i < RETRY_COUNT; i++) {
            ...
            if (ar.isSuccess()) {
                ...
                try {
					_atmc.set(mpAct.getMpId(), 7170,at);
