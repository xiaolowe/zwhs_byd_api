...
public interface CashRecoderDao extends JpaRepository<CashRecoder, Integer>,
		JpaSpecificationExecutor<CashRecoder> {
	
	public List<CashRecoder> findByStoreId(int storeId);
	
	public Page<CashRecoder> findByStoreId(int storeId,Pageable pageable);
