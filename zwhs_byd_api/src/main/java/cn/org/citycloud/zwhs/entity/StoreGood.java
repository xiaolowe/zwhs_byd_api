...
public class StoreGood implements Serializable {
	...
	@Column(name="retail_sale_price", precision=10, scale=2)
	private BigDecimal retailSalePrice;
	
	@Column(name="retail_price_low", precision=10, scale=2)
	private BigDecimal retailPriceLow;
	
	@Column(name="retail_price_high", precision=10, scale=2)
	...
	public BigDecimal getRetailPriceLow() {
		return retailPriceLow;
	}

	public void setRetailPriceLow(BigDecimal retailPriceLow) {
		this.retailPriceLow = retailPriceLow;
	}

	public BigDecimal getRetailPriceHigh() {
		return retailPriceHigh;
	}

	public void setRetailPriceHigh(BigDecimal retailPriceHigh) {
