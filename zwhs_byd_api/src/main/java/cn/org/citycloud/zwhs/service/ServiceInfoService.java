...
public class ServiceInfoService {
	 ...
	 * @return
	 */
	public ServiceInfo checkServiceInfoById(Integer serviceId, Integer serviceVerify){
		
		ServiceInfo serviceInfo = serviceInfoDao.findOne(serviceId);
		serviceInfo.setServiceVerify(serviceVerify);  // 1 为审核通过     	2为驳回
	 ...
	 * @return
	 */
	public ServiceInfo updownServiceInfoById(Integer serviceId, Integer serviceState){
		
		ServiceInfo serviceInfo = serviceInfoDao.findOne(serviceId);
		serviceInfo.setServiceState(serviceState);  // 0 下架     1上架
