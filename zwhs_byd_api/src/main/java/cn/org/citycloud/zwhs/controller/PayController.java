...
public class PayController extends BaseController{
	...
	public Object payList(@Valid Page page){
		...
		return cashRecoderDao.findByStoreId(getStoreId(),pageable);
	}
	...
	public Object payApply(@RequestBody @Valid Pay pay)throws Exception{
		pay.setStoreId(getStoreId());
		pay.setApplyUserId(getUserToken().getUserId());
		return payService.ApplyPay(pay);
	}
	...
	public Object payMoney(){
		return finAccDao.findByAccNo(getStoreId());
	}
